        ...
        <asp:DetailsView ID="PageDetailsView" runat="server" Height="50px" Width="900px" AutoGenerateRows="False" DataSourceID="PageDataSource" DataKeyNames="ContentId,ParentPage,ContentName,ContentDetails,ContentOrder,Created,Modified,isDeleted" OnItemCommand="PageDetailsView_ItemCommand" OnItemUpdating="PageDetailsView_ItemUpdating" OnItemUpdated="PageDetailsView_ItemUpdated">
            <Fields>
                ...
                <asp:TemplateField HeaderText="Title" SortExpression="ContentName">
                    <EditItemTemplate>
                        <asp:TextBox ID="TitleText" runat="server" Text='<%# Bind("ContentName") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Content" SortExpression="ContentDetails">
                    <EditItemTemplate>
                        <asp:TextBox ID="ContentText" runat="server" Text='<%# Bind("ContentDetails") %>'></asp:TextBox>
                    </EditItemTemplate>
                </asp:TemplateField>
