...
namespace BLL
{
    ...
    {
        //private static readonly string _connectionString = "baranofEntities"; // Set the connection string
        //private static readonly string _pwd = "DIJGKD%%^324234"; // Set the password

        private static readonly string _connectionString = "barano5_Entities"; // Set the connection string
        private static readonly string _pwd = "Df@q4y40"; // Set the password
